...
class BookAPI:
    ...
    def detect_genre(self, categories: list) -> str:
        ...
        if not categories or categories == ['Unknown']:
            return "Fantasy"  # Default for books with unknown categories
        
        # Common genre mappings with more keywords
        genre_keywords = {
        ...
        # Flatten categories into a single string for matching
        ...
        # Special case for popular fantasy books that might not have proper categories
        fantasy_titles = ['game of thrones', 'lord of the rings', 'hobbit', 'harry potter', 'wheel of time']
        title_check = categories_text  # We'll check the description later
